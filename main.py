...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.main_text.setText(_translate("MainWindow", "Говно"))
        ...
        self.pushButton.clicked.connect(self.first_button)
        
    def first_button(self, MainWindwow):
        text = 'лох'
